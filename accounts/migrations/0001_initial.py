    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('suscriptor', 'Suscriptor'), ('autor', 'Autor'), ('editor', 'Editor'), ('publicador', 'Publicador'), ('administrador', 'Administrador')], default='suscriptor', max_length=50)),
